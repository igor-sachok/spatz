...
void TEST_CASE1(void) {
  ...
  VLOAD_64(v2, 0xffffffffffffffff, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VLOAD_64(v4, 0xfff2ffffffffffff, 0x0100000000000000, 0xf0f0f0f0f0f0f0f0,
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xaa, 0xaa);
  VCLEAR(v6);
  asm volatile("vmseq.vv v6, v2, v4, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(8, v6, 0x88, 0x88);
};
...
void TEST_CASE5(void) {
  ...
  VLOAD_64(v2, 0x000000000000000f, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VCLEAR(v4);
  asm volatile("vmseq.vi v4, v2, 15");
  VSET(2, e8, m1);
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0x10, 0x10);
  VCLEAR(v4);
  asm volatile("vmseq.vi v4, v2, 15, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(24, v4, 0x10, 0x10);
};
