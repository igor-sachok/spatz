...
void TEST_CASE1(void) {
  ...
  VLOAD_64(v6, 0xfff2ffffffffffff, 0x0100000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VCLEAR(v4);
  asm volatile("vmsne.vv v4, v2, v6");
  VSET(2, e8, m1);
  VCMP_U8(4, v4, 0x33, 0x33);
};
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xaa, 0xaa);
  VCLEAR(v4);
  asm volatile("vmsne.vv v4, v2, v6, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(8, v4, 0x22, 0x22);
};
...
//            0x0f0f0f0f0f0f0f0f);
//   VCLEAR(v4);
//   asm volatile("vmsne.vx v4, v2, %[A]" ::[A] "r"(scalar));
//   VSET(2, e8, m1);
//   VCMP_U8(12, v4, 0xff, 0xff);
};
...
//   VLOAD_8(v0, 0x10, 0x10);
//   VCLEAR(v4);
//   asm volatile("vmsne.vx v4, v2, %[A], v0.t" ::[A] "r"(scalar));
//   VSET(2, e8, m1);
//   VCMP_U8(16, v4, 0x10, 0x10);
};
...
void TEST_CASE5(void) {
  ...
  VLOAD_64(v2, 0x000000000000000f, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
           ...
           0x0f0f0f0f0f0f0f0f);
  VCLEAR(v4);
  asm volatile("vmsne.vi v4, v2, 15");
  VSET(2, e8, m1);
  VCMP_U8(20, v4, 0xee, 0xee);
};
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0x10, 0x10);
  VCLEAR(v4);
  asm volatile("vmsne.vi v4, v2, 15, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(24, v4, 0x00, 0x00);
};
