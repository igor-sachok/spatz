...
void TEST_CASE1(void) {
  ...
  VLOAD_64(v6, 50, 7000, 400, 19901, 50, 7000, 400, 19901, 50, 7000, 400, 19901,
           50, 7000, 400, 19901);
  VCLEAR(v4);
  asm volatile("vmsle.vv v4, v2, v6");
  VSET(2, e8, m1);
  VCMP_U8(3, v4, 0xAB, 0xAA);
};
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsle.vv v4, v2, v6, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(6, v4, 0x88, 0x88);
};
...
void TEST_CASE3(void) {
  ...
  VLOAD_64(v2, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v4);
  asm volatile("vmsle.vx v4, v2, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  VCMP_U8(10, v4, 0x66, 0x66);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsle.vx v4, v2, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  VCMP_U8(14, v4, 0x44, 0x44);
};
...
void TEST_CASE5(void) {
  ...
  VLOAD_64(v2, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v4);
  asm volatile("vmsle.vi v4, v2, 15");
  VSET(2, e8, m1);
  VCMP_U8(18, v4, 0x66, 0x66);
};
...
void TEST_CASE6(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsle.vi v4, v2, 15, v0.t");
  VSET(2, e8, m1);
  VCMP_U8(22, v4, 0x44, 0x44);
};
