...
void TEST_CASE1(void) {
  ...
  VLOAD_64(v2, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v4);
  asm volatile("vmsgt.vx v4, v2, %[A]" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  VCMP_U8(4, v4, 0x99, 0x99);
};
...
void TEST_CASE2(void) {
  ...
  VLOAD_8(v0, 0xCC, 0xCC);
  VCLEAR(v4);
  asm volatile("vmsgt.vx v4, v2, %[A], v0.t" ::[A] "r"(scalar));
  VSET(2, e8, m1);
  VCMP_U8(8, v4, 0x88, 0x88);
};
...
void TEST_CASE3(void) {
  ...
  VLOAD_64(v2, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
           12345, -8, -25, 199);
  VCLEAR(v4);
  asm volatile("vmsgt.vi v4, v2, 15");
  VSET(2, e8, m1);
  VCMP_U8(12, v4, 0x99, 0x99);
};
