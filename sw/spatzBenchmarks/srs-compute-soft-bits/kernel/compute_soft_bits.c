...
void compute_soft_bits_(int8_t *this_soft_bits, const int8_t *this_var_to_check, const int8_t *this_check_to_var, const uint32_t lifting_size) {
...
asm volatile("vmv.v.i v28, 0");
    ...
    asm volatile("vadd.vv v12, v20, v28, v0.t");
