...
`include "common_cells/registers.svh"
  ...
  if (Pipeline) begin: gen_pipeline
    ...
    // Is the operation signed?
    logic is_signed_d;
    assign is_signed_d = operation_i inside {VMIN, VMAX, VMULH, VMULHSU, VDIV, VREM, VMSGT, VMSLE, VMSLT, VSADD};
    ...
    // Is the operation signed?
    assign is_signed = operation inside {VMIN, VMAX, VMULH, VMULHSU, VDIV, VREM, VMSGT, VMSLE, VMSLT, VSADD};
